...
# 套用旋轉
rotate_point_cloud(pcd0, angle_x=130)
rotate_point_cloud(pcd1, angle_x=130, angle_y=90, angle_z=6)
rotate_point_cloud(pcd2, angle_x=124, angle_y=180, angle_z=6)
rotate_point_cloud(pcd3, angle_x=120, angle_y=270 , angle_z=12)
