...
def generate_aruco_marker_with_trim_line(marker_id, marker_size=151, dictionary=aruco.DICT_6X6_50, trim_line_offset_cm=1):      # 5cm的aruco Pixel為188.98, 4cm Pixel為151.18, 16cm Pixel為604.72
...
# 生成 ID 为 0 的 ArUco 标记并添加 1 公分的修剪线
